...
<body>
    <table BORDER='3' width='600' bgcolor='cyan' cellspacing='3' cellpaddling='3'>
        <CAPTION align="above">SLOT TIMETABLE - MALAR MARIAM (23005717)</CAPTION>
        <tr>
    ...
    <table border="3" width="600" cellspacing="3" cellpaddlings="3">
        ...
        <tr>
            ...
            <td align="centre">Fundamentals of Web Application Development(FWAD)</td>
        </tr>
